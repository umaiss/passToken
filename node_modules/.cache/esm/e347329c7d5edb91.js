let express,fetch,cookieSession;_7d5‍.w("express",[["default",["express"],function(v){express=v}]]);_7d5‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_7d5‍.w("cookie-session",[["default",["cookieSession"],function(v){cookieSession=v}]]);
...
_7d5‍.g.console.log({ client_id, client_secret });
...
app.listen(PORT, () => _7d5‍.g.console.log("Listening on localhost:" + PORT));